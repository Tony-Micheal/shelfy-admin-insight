...
export function Filters() {
  ...
  return (
    <div className="w-[280px] border-l border-gray-200 bg-white p-5 h-screen fixed right-0 top-0 overflow-y-auto">
      ...
      <div className="space-y-5">
        ...
        <div className="pt-4">
          <Button className="w-full bg-shelfy-orange hover:bg-shelfy-orange/90">
            Apply Filters
          </Button>
